...
export default function Statistics() {
  return (
    ...
    <main className="flex flex-col w-screen h-auto items-center justify-center gap-2">
      <h1 className=" text-2xl font-Inknut md:text-4xl font-semibold mt-28">
        Market Research
      </h1>
      <section className="flex flex-row justify-evenly items-center mt-24 md:mx-28 gap-12">
        ...
        <div className=" flex flex-col gap-12 md:mb-16 mx-10">
          <h2 className=" text-xl font-Inknut  md:text-3xl">A Giant Market is going to experience a fresh innovation</h2>
          <p className=" text-xs font-Inknut font-normal md:text-sm tracking-widest">
      ...
      <h1 className=" font-Inknut text-2xl md:text-4xl font-semibold mt-10 md:mt-32">
      ...
      <section className="flex flex-row flex-wrap-reverse justify-evenly items-center my-24 mx-10 gap-72">
        <div className=" lg:flex flex-col gap-10">
          <h2 className="font-Inknut font-semibold text-2xl md:text-4xl md:my-10">Top States in Crimes</h2>
            <ul className="list-disc space-y-6 font-Inknut text-xs md:text-base font-normal my-20">
